...
All 19 deliverables prepared in this project are saved here. The `current` folder contains the latest completed materials; `archive` retains earlier drafts and proofs for reference. File names and contents match the delivered originals. `SHA256SUMS` records their checksums.
